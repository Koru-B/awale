...
def displayGameState(state: GameState):
    ...
    while running:
        ...
        #Ligne du haut
        textTBD = textfont.render(f"{state.p1pad[0]:^7}", 1, (255, 255, 255))
        screen.blit(textTBD, (140, 190))
            
        textTBD = textfont.render(f"{state.p1pad[1]:^7}", 1, (255, 255, 255))
        screen.blit(textTBD, (234, 190))
            
        textTBD = textfont.render(f"{state.p1pad[2]:^7}", 1, (255, 255, 255))
        screen.blit(textTBD, (328, 190))
            
        textTBD = textfont.render(f"{state.p1pad[3]:^7}", 1, (255, 255, 255))
        screen.blit(textTBD, (422, 190))
            
        textTBD = textfont.render(f"{state.p1pad[4]:^7}", 1, (255, 255, 255))
        screen.blit(textTBD, (516, 190))
            
        textTBD = textfont.render(f"{state.p1pad[5]:^7}", 1, (255, 255, 255))
        screen.blit(textTBD, (610, 190))
            
        #Ligne du bas
        textTBD = textfont.render(f"{state.p2pad[0]:^7}", 1, (255, 255, 255))
        screen.blit(textTBD, (140, 352))
            
        textTBD = textfont.render(f"{state.p2pad[0]:^7}", 1, (255, 255, 255))
        screen.blit(textTBD, (234, 352))
            
        textTBD = textfont.render(f"{state.p2pad[0]:^7}", 1, (255, 255, 255))
        screen.blit(textTBD, (328, 352))
            
        textTBD = textfont.render(f"{state.p2pad[0]:^7}", 1, (255, 255, 255))
        screen.blit(textTBD, (422, 352))
            
        textTBD = textfont.render(f"{state.p2pad[0]:^7}", 1, (255, 255, 255))
        screen.blit(textTBD, (516, 352))
            
        textTBD = textfont.render(f"{state.p2pad[0]:^7}", 1, (255, 255, 255))
        screen.blit(textTBD, (610, 352))
            
        #A gauche et à droite
        textTBD = textfont.render(f"{state.p1points:^10}", 1, (255, 255, 255))
        screen.blit(textTBD, (35, 271))
            
        textTBD = textfont.render(f"{state.p2points:^10}", 1, (255, 255, 255))
        screen.blit(textTBD, (708, 271))
